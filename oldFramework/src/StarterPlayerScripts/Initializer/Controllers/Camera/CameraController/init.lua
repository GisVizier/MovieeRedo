...
function CameraController:UpdateOrbitCamera(camera, deltaTime)
	...
	-- Get pivot point (character position + height)
	local pivotPosition = self.PrimaryPart.Position + Vector3.new(0, orbitConfig.Height + self.CurrentCrouchOffset, 0)
	...
	-- IMPORTANT: Never let camera collision hit any rigs (local or other players)
