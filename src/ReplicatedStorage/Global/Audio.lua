...
Audio.Sounds = {
	Movement = {
		...
		FootstepPlastic = { Id = Audio.SoundIds.FootstepPlastic, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepGrass = { Id = Audio.SoundIds.FootstepGrass, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepMetal = { Id = Audio.SoundIds.FootstepMetal, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepWood = { Id = Audio.SoundIds.FootstepWood, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepConcrete = { Id = Audio.SoundIds.FootstepConcrete, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepFabric = { Id = Audio.SoundIds.FootstepFabric, Volume = 0.16, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepSand = { Id = Audio.SoundIds.FootstepSand, Volume = 0.2, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
		FootstepGlass = { Id = Audio.SoundIds.FootstepGlass, Volume = 0.16, Pitch = 1.0, MinDistance = 5, MaxDistance = 50 },
	},
}
